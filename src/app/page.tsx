...
export const metadata: Metadata = {
	description:
		"Hi, I'm Ali Hamas, a self-taught developer who's currently pursuing Full-Stack development to create stunning user experiences on the front-end and scalable infrastructure on the back-end."
};
