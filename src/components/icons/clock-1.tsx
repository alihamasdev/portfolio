...
const animations = {
	default: {
		...
		line1: {
			...
			animate: { transformOrigin: "bottom left", rotate: [0, 20, 0], transition: { ease: "easeInOut", duration: 0.6 } }
		},
		line2: {
			initial: { rotate: 0, transition: { ease: "easeInOut", duration: 0.6 } },
...
function IconComponent({ size, ...props }: Clock1Props) {
	...
	return (
		...
		>
			...
			<motion.line x1={14.5} y1={8} x2={12} y2={12} variants={variants.line1} initial="initial" animate={controls} />
...
export { animations, Clock1, Clock1 as Clock1Icon, type Clock1Props, type Clock1Props as Clock1IconProps };
