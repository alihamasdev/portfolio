				...
				<TooltipPortal>
					...
					>
						<motion.div
							...
							transition={transition}
							className="bg-primary fill-primary text-primary-foreground relative w-fit rounded-md px-3 py-1.5 text-xs font-medium text-balance shadow-md"
						>
...
function Tooltip({ children, side = "top", sideOffset = 14, align = "center", alignOffset = 0 }: TooltipProps) {
	...
	const value = { content, setContent, arrow, setArrow, side, sideOffset, align, alignOffset, id };
